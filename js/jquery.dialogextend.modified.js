/***
   Slightly modified by me to allow for localized names for the "minimize" etc. button's tooltips.
   Original source here: https://github.com/ROMB/jquery-dialogextend
*/
...
(function() {
  ...
  $.widget("ui.dialogExtend", {
    ...
    options: {
	  ...
	  "maximizeTitle": "minimize",
	  "collapseTitle": "collapse",
	  "restoreTitle": "restore99",
      "icons": {
    ...
    _initButtons: function() {
      ...
      buttonPane.append('<a class="ui-dialog-titlebar-restore ui-corner-all ui-state-default" href="#"><span class="ui-icon ' + this.options.icons.restore + '" title="' + _this.options.restoreTitle + '">' + _this.options.restoreTitle + '</span></a>').find('.ui-dialog-titlebar-restore').attr("role", "button").mouseover(function() {
    ...
    _initModuleButton: function(name, mode) {
	  ...
	  var displayName = name==="maximize" ? _this.options.maximizeTitle : name==="minimize" ? _this.options.minimizeTitle : _this.options.collapseTitle;
      return buttonPane.append('<a class="ui-dialog-titlebar-' + name + ' ui-corner-all ui-state-default" href="#" title="' + displayName + '"><span class="ui-icon ' + this.options.icons[name] + '">' + displayName + '</span></a>').find(".ui-dialog-titlebar-" + name).attr("role", "button").mouseover(function() {
        return $(this).addClass("ui-state-hover");
      }).mouseout(function() {
        return $(this).removeClass("ui-state-hover");
      }).focus(function() {
