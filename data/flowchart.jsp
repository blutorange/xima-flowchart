...
<%!public JSONObject getImageIcon(String actionIcon, JSONObject imageFont, Map<String,Integer> imageFontMap, Map<String,String> imageFontValues) {
  ...
  public JSONObject getAktionJson(Aktion action, JSONObject imageFont, Status status, JSONArray transitionsJsonArray, Locale locale, Map<String,Integer> imageFontMap, Map<String,String> imageFontValues) {
    JSONObject j = new JSONObject();
    ...
    try {
      ...
      // Properties
      PropJsonObject.put("de.xima.fc.status.name", action.getName());
  ...
  public JSONObject getStatusJson(Status status, JSONObject imageFont, JSONObject resourceUserGroups, JSONArray transitionsJsonArray, Locale locale, Map<String,Integer> imageFontMap, Map<String,String> imageFontValues) {
    ...
    try {
      ...
      for (Aktion a : actions) {
        ActionArray.put(getAktionJson(a, imageFont, status, transitionsJsonArray, locale, imageFontMap, imageFontValues));
      }
      ...
      if (timerTargetStatus != null) {
        ...
        timedTransitionDetails.put("onlyForUnread", timerOffset);
...
<%
  ...
  try {
    ...
    for (Status s : statusListe) {
      statusJsonArr.put(getStatusJson(s, imageFontJsonObject, userGroupJsonObject, edgesJsonArr, locale, imageFontMap, imageFontValues));
    }
    ...
    resourcesJsonObject.put("file", fileJsonObject);
    ...
    propJsonObject.put("de.xima.fc.statusAfterResubmission", "de.xima.fc.status-" + String.valueOf(wiedervorlage.getId()));
